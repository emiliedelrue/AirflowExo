...
def pipeline_dvf():
    ...
    def verifier_sources() -> dict:
        ...
        try:
            ...
            resp.close()  # On ferme immédiatement sans lire le contenu
    ...
    def stocker_hdfs_raw(local_path: str) -> str:
        ...
        # 3 : Envoyer le fichier au DataNode (étape 2)
        ...
        # 4 : Ne pas supprimer — c'est le fichier source local (pas un temporaire)
